...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      it "should not show delete link for non-admin users" do
        get :index
    ...
    describe "for admin users" do
      ...
      it "should not show delete link for themselves" do
        get :index
        response.should_not have_selector("a", :content => "delete")
      end
    end
    ...
    describe "as an admin user" do
      ...
      describe "cannot destroy themselves" do
        ...
        it "should have a failure message" do
          post :destroy, :id => @admin
            flash[:failure].should =~ /you cannot delete your own account/i
        end
